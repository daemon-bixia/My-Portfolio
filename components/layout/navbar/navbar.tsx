...
const Navbar = () => {
  ...
  return (
    <div id="home" className={styles.navbarWrapper} ref={navWrapperElement}>
      <nav className={styles.navbar} ref={navElement}>
        ...
        <div
          ...
          <ul className={styles.links}>
            <li className={styles.link}><Link onClick={closeMenu} typography="body-2" href="#home">About</Link></li>
            <li className={styles.link}><Link onClick={closeMenu} typography="body-2" href="#skills">Skills</Link></li>
            <li className={styles.link}><Link onClick={closeMenu} typography="body-2" href="#projects">Portfolio</Link></li>
            <li className={styles.link}><Link onClick={closeMenu} typography="body-2" href="#contact">Contact</Link></li>
          </ul>
        </div>
